            ...
            <div class="col-md-9 col-lg-9" style ="border: 1px solid rgba(116, 23, 187, 0.19);">
                <div style="font-family: Tahoma; padding: 3px; font-size: 11pt; color: black; ">
                    ...
                    foreach($viewsData['users'] as $ingr)
                    {
                        ...
                        $buk="<A HREF='battle_pvp.php?enemy_id=".$ingr['id']."'>Схватка</a>";

                        echo "
                        <tr >
                        <td style='padding: 2px;' width='5%' bgcolor='white'><center>".$k."</center></td>
		                ...
		                <td style='padding: 2px;' width='20%' bgcolor='white'><center>".$buk."</center></td>
		                </tr>";
                    ...
                    echo "<br><center><A HREF='/Users/main'>Вернуться назад</A></center>";
                    ?>
